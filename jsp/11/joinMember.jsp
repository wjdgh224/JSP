...
<body>
	...
	<form action="joinOk.jsp" method="post">
		...
		<p><b>아이디 : </b> <input type="text" name="id" placeholder="아이디를 입력하세요." required="required">
		<p><b>비밀번호 : </b> <input type="password" name="pw" placeholder="비밀번호를 입력하세요." required="required">
