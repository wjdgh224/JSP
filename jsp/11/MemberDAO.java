...
public class MemberDAO {
	 ...
	 * dataSource = (DataSource)context.lookup("java:comp/env/" + "jdbc/dbconn");
	 * conn = dataSource.getConnection();
	 * System.out.println("DBCP에 있는 커넥션 객체 얻어오기 성공"); System.out.println("스레드명 : " +
	...
	//MemberDTO테이블에 있는 데이터 리스트를 가져오는 메서드
	...
	//신규 회원정보를 DB 및 ArrayList추가, 저장하는 메서드
